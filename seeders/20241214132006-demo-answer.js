...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert("answers", [
      ...
      {
        answer: `По приказу №2 от 04 января 2024 ж. "Об утверждении Методических рекомендации по внедрению интегрального, GPA обучающихся организаций высшего и послевузовского образования.`,
        created_at: new Date(),
        modified_at: new Date(),
        created_by: 1,
        modified_by: 1,
